...
useEffect(() => {
  ...
  return(
    <div className='x-w-2xl mx-auto p-4 bg-white shadow-md rounded-lg mt-6'>
      <h2 className='text-2xl font-bold m'>Comment Section</h2>
      <form onSubmit  ={handleSubmit} className='mb-4'>
        ...
        focus :outline-none'> Submit Comment</button>
      </form>
      <div>
